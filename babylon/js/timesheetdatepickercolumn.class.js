...
//********************************************************************************************************************************************************
	...
	function TimeSheetDatepickerColumn(name,dataVariable,validationFunction,updateAction) {																				
		...
		this.createEventListeners = function() {																								
			...
			sourceElement.onchange = function() {
				...
				if(!isValid) {
					sourceElement.className = "timesheet-datepicker-error";
				}
				if(isValid)	 {
					sourceElement.className = "timesheet-datepicker-valid";
				}
		...
		this.createDomElement = function() {
			...
			var domElement = this.createTimeSheetDatepickerElement();
		...
		this.createTimeSheetDatepickerElement = function() {																								
																																								
			var input 	= document.createElement('input');	
			$(input).datepicker({dateFormat: 'dd.mm.yy', firstDay: 1});
			input.size  = 8;																													
