...
echo "<table  cellspacing='0' cellpadding='0' style='margin-bottom:20px;width:800px;border-spacing:0px;border-collapse:collapse;'>";
echo "<tr>";
echo "	<div style='width:800px;display: table;table-layout: fixed;border-spacing:0;'>";
...
if ($registry->viewID == 4) {
	echo "<div onclick=\"openview(4)\"  class='header-selection-right-selected' style='" . $stylestring . "'>";
	echo "Archive";
	echo "</div>";
} else {
	echo "<div onclick=\"openview(4)\"  class='header-selection-right' style='" . $stylestring . "'>";
	echo "Archive";
	echo "</div>";
}
echo "	</tr>";
...
echo "			var url = '" .  getUrl("tasks/board/showboard") . "&viewID='+viewID;";
