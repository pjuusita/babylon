...
function createRows() {
	...
	for($day=0;$day<7;$day++) {
		...
		for($hours=0;$hours<24;$hours++) {
			...
			if ($modulo!=0) echo "<td colspan=10 style='background-color : lightgray; border-width : 1px; border-style : none none none solid; border-color : darkgray; padding : 0px 0px 0px 0px;'>&nbsp&nbsp</td>";
			if ($modulo==0) echo "<td colspan=10 style='background-color : lightgray; border-width : 1px; border-style : none none none solid; border-color : black; padding : 0px 0px 0px 0px;'>&nbsp&nbsp</td>";
		...
		echo "<tr ondragenter='middleRowOnDragEnter(event)' ondragleave='middleRowOnDragLeave(event)' ondragover='preventDefaults(event)' ondrop='onDropNewRow(event)' style='background-color : lightgray; height : 6px; display : none'>";
		echo "<td colspan=241></td>";
		/*for($hours=0;$hours<240;$hours++) {
				
			$modulo = $hours%10;
		
			if ($modulo!=0) echo "<td ondragenter='onDragEnter(event)' ondragleave='onDragLeave(event)' ondragover='preventDefaults(event)' ondrop='onDropElement(event)' style='background-color : lightgray; border-width : 1px; border-style : none none none dotted; border-color : white; padding : 0px 0px 0px 0px;'></td>";
			if ($modulo==0) echo "<td ondragenter='onDragEnter(event)' ondragleave='onDragLeave(event)' ondragover='preventDefaults(event)' ondrop='onDropElement(event)' style='background-color : lightgray; border-width : 1px; border-style : none none none solid; border-color : white; padding : 0px 0px 0px 0px;'></td>";
