...
if ($subject=="Kaikki tyantekijat") {
	...
	$shiftLengthColumn  = new PDFTableColumn("Kesto","shiftlength",15);
	
	$shiftTable->addColumn($dateColumn);
	$shiftTable->addColumn($shiftSpanColumn);
	$shiftTable->addColumn($shiftLengthColumn);
...
if ($subject!="Kaikki tyantekijat") {
	...
	$dateColumn			= new PDFTableDateColumn("Pvm","date",25,'d.m.D');
	$shiftSpanColumn	= new PDFTableColumn("Aika","shiftspan",30);
	$shiftLengthColumn  = new PDFTableSumColumn("Kesto","shiftlength",15,"double");
