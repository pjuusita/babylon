...
$insertsection->setSaveAction(UIComponent::ACTION_FORWARD, 'admin/usermanagement/adduser');
...
$table->setLineAction(UIComponent::ACTION_FORWARD, 'admin/usermanagement/showuser','itemID');

$button = new UIButton(UIComponent::ACTION_OPENDIALOG, $insertsection->getID(), "Lisää käyttäjä");
$table->addButton($button);

$column = new UISortColumn("Username", "username");
$table->addColumn($column);

$column = new UISortColumn("Etunimi", "firstname");
$table->addColumn($column);

$column = new UISortColumn("Sukunimi", "lastname");
$table->addColumn($column);
