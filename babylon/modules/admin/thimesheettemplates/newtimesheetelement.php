...
echo "<a href='".getUrl('system/doctemplates/showdoctemplates')."'>Palaa tauluun</a><br>";
echo "<h1></h1>";

$insertsection = new UIInsertSection("Uuden Timesheettemplaten lisays");
$insertsection->setInsertAction('system/doctemplates/inserttemplate', false);
