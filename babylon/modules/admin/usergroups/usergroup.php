...
echo "<a href='".getUrl('admin/usergroups/showusergroups')."'>Palaa käyttäjäryhmiin</a><br>";
...
$section->setUpdateAction(UIComponent::ACTION_FORWARD,'admin/usergroups/updateusergroup&usergroupID=' . $registry->usergroup->usergroupID, 'rowID');
...
$section->setSaveAction(UIComponent::ACTION_FORWARD, 'admin/usergroups/saveusergroups&groupID=' . $this->registry->usergroup->usergroupID);
...
function changeAccessRightsDiv() {
	...
	foreach($registry->modules as $index => $module) {
		...
		if ($module->name == "System") {
			...
			echo "		var url = '" .  getUrl("admin/usergroups/updateusergroupmoduleaccess") . "&usergroupID=" . $usergroupID . "&moduleID='+moduleID+'&accesskeyID='+accesskeyID+'&accesslevel='+level;";
			echo "		console.log('ulr - '+url);";
			echo "		window.location = url;";
			echo "	}";
			echo "</script>";
			...
			echo "		var url = '" .  getUrl("admin/usergroups/updateusergroupmoduleaccess") . "&usergroupID=" . $usergroupID . "&moduleID='+moduleID+'&accesslevel='+level;";
			echo "		console.log('ulr - '+url);";
			echo "		window.location = url;";
			echo "	}";
			echo "</script>";
...
$button = new UIButton(UIComponent::ACTION_FORWARD, "admin/usergroups/updateusergroupmenu&id=" . $registry->usergroup->usergroupID, "Update menu");
$managementSection->addButton($button);

$button = new UIButton(UIComponent::ACTION_FORWARD, "admin/usergroups/removeusergroup&id=" . $registry->usergroup->usergroupID, "Poista käyttäjäryhmä");
$managementSection->addButton($button);
