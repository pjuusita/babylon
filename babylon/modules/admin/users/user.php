...
echo "<a href='".getUrl('admin/users/showusers')."'>Palaa käyttäjätauluun</a><br>";
...
$section->setUpdateAction(UIComponent::ACTION_FORWARD,'admin/users/updateuser', 'userID');
...
$section->setOpen(true);
$section->setUpdateAction(UIComponent::ACTION_FORWARD,'admin/users/updateusersettings&usergroupID=' . $registry->user->usergroupID, 'userID');
...
$section->setOpen(true);
$section->setUpdateAction(UIComponent::ACTION_FORWARD,'admin/usergroups/updateusergroup', 'groupID');
...
function changeVisibilityDiv() {
	...
	echo "			var url = '" . getUrl('admin/users/checkuservisibility') . "&userID=" . $registry->user->userID . "&usergroupID=" . $registry->user->usergroupID . "&dimensionID='+dimensionID+'&contentID='+contentID;";
	echo "			console.log(url);";
	echo "			$.getJSON('" . getUrl('admin/users/checkuservisibility') . "&userID=" . $registry->user->userID . "&usergroupID=" . $registry->user->usergroupID . "&dimensionID='+dimensionID+'&contentID='+contentID,'',function(data) {";
	...
	echo "			$.getJSON('" . getUrl('admin/users/uncheckuservisibility') . "&userID=" . $registry->user->userID . "&usergroupID=" . $registry->user->usergroupID . "&dimensionID='+dimensionID+'&contentID='+contentID,'',function(data) {";
	echo "				console.log('uncheckuservisibility - '+data);";
	echo "			}); ";
	echo "		}";
	...
	//echo "		var url = '" .  getUrl("admin/usergroups/updatedimensionvisibility") . "&usergroupID=" . $usergroupID . "&dimensionID='+dimensionID+'&accesslevel='+level;";
	//echo "		console.log('ulr - '+url);";
	//echo "		window.location = url;";
	echo "	}";
	echo "</script>";
...
$button = new UIButton(UIComponent::ACTION_FORWARD, "admin/users/removeuserrights&id=".$registry->user->userID, "Poista käyttöoikeudet");
