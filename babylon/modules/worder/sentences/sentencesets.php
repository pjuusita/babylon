...
$filterbox->addSelectFilter($this->registry->languageID, $this->registry->languages, "worder/sentences/showsentencesets", "","languageID", "name");
$filterbox->show();
echo "		</td>";
echo "	</tr>";
echo "</table>";
...
$table = new UITreeSection("Sentence Sets", "900px");
$table->setFramesVisible(false);

$table->setLineAction(UIComponent::ACTION_FORWARD,"worder/sentences/showsentenceset","setID");
...
$field = new UISortColumn("Ruleset", "rulesetID", 'rulesetID');
$table->addColumn($field);

$field = new UISelectColumn("Ruleset","name","rulesetID",$registry->rulesets, "name");
$table->addColumn($field);
