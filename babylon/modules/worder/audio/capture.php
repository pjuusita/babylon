...
$filterbox->addSelectFilter($this->registry->languageID, $this->registry->languages, "worder/audio/showaudiocapture", "","languageID", "name");
$filterbox->show();
echo "		</td>";
...
$filterbox = new UIFilterBox();
$filterbox->addSelectFilter($this->registry->setID, $this->registry->sets, "worder/audio/showaudiocapture", "","setID", "name");
$filterbox->show();
echo "		</td>";
...
echo "			console.log('create frequency graph');";
echo "			can1 = document.getElementById('canvas01');";
echo "			createFrequencyGraph(source,can1);";
echo "			console.log('end create frequency graph');";
