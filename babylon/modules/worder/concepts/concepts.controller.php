...
class ConceptsController extends AbstractController {
    ...
    public function showconceptAction() {
        ...
        $this->registry->definitions = Table::load("worder_definitions", "WHERE ConceptID=" . $conceptID . " AND GrammarID=" . $_SESSION['grammarID']);
        $this->registry->sources = Table::load('worder_sources');
     ...
     * @param number $parentlinks
     * @param number $componentlinks
     * @param number $argumentlinks
     * @param number $saveactive
     */
     ...
     * parametriin
     *
     * @param number $parentarray		ConceptID:t joiden childit halutaan etsiä, alkuperäisessä kutsussa yksi itemi, mutta rekursio lisää löydetyt childit tähän
     * @param number $childarray		Taulukko johon lisätään kaikki löydetyt lapset, level-järjestyksessä, voi sisältää tuplia
     * @param number $parentlinks		Taulukkoon lisätään kaikki ladatut parentlinksit, näitä ei tarvitse ladata uudelleen
