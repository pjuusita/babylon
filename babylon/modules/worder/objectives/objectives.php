...
echo "<a href='" . getUrl("worder/objectives/showobjectivelist") . "'>list</a>";
...
$column = new UISortColumn("#", "objectiveID", "worder/objectives/showobjective", null, "10%");
$table->addColumn($column);

$column = new UISortColumn("Objective", "name");
$table->addColumn($column);

$table->setData($registry->objectives);
$table->show();
*/



$table = new UITreeSection("Objectives", "600px");
$table->setLineAction(UIComponent::ACTION_FORWARD,"worder/objectives/showobjective","objectiveID");
